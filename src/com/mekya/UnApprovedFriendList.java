...
public class UnApprovedFriendList extends ListActivity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(0, APPROVE_SELECTED_FRIENDS_ID, 0,
				R.string.approve_selected_friends);
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item) {
		...
		case APPROVE_SELECTED_FRIENDS_ID: {
			...
			Toast.makeText(UnApprovedFriendList.this, R.string.request_sent,
